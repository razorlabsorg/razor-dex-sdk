...
import { BigintIsh, ZERO, ONE, TWO, THREE, MoveType, MOVE_TYPE_MAXIMA } from './constants'
...
export function validateMoveTypeInstance(value: JSBI, moveType: MoveType): void {
  ...
  invariant(
    JSBI.lessThanOrEqual(value, MOVE_TYPE_MAXIMA[moveType]),
    `${value} is not a ${moveType}.`,
  )
}
