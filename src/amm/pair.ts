...
export class Pair {
  ...
  private static addressComputationPromises: Map<string, Promise<void>> =
    new Map();
  ...
  private static async precomputeAddress(
    tokenA: Asset,
    tokenB: Asset,
  ): Promise<void> {
    const cacheKey = this.getCacheKey(tokenA, tokenB);
    if (
      !this.addressCache.has(cacheKey) &&
      !this.addressComputationPromises.has(cacheKey)
    ) {
  ...
  private constructor(
    currencyAmountA: CurrencyAmount<Asset>,
  ...
  public getOutputAmount(
    inputAmount: CurrencyAmount<Asset>,
  ): [CurrencyAmount<Asset>, Pair] {
  ...
  public getInputAmount(
    outputAmount: CurrencyAmount<Asset>,
  ): [CurrencyAmount<Asset>, Pair] {
